...
import NotificationShowcase from '../storyUtils/NotificationShowcase';
import { FIGMA_URL } from '../../utils/common';

<Meta title="Design System/Notification" component={InlineNotification} parameters={{
  design: {
    type: 'figma',
    url: `${FIGMA_URL}?node-id=10283%3A104363`,
  },
}} />
