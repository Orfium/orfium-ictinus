...
<Preview>
  <Story name="Icon Button Sizes">
    <Stack>
      <Button
        size={'lg'}
        iconLeft={<Icon name={'dashboard'} color={'primary'} size={rem(14)} />}
        dataTestId={'size-lg'}
      >
        Hello world
      </Button>
...
<Preview>
  <Story name="Button Types">
    <Stack>
      <Button size={'sm'} isDisabled type="success">
        Success
      </Button>
...
<Preview>
  <Story name="Button Colors">
    <Stack>
      <Button size={'sm'} isDisabled color={'red-500'}>
        Disabled
      </Button>
      <Button size={'sm'} color={'red-600'}>
        Red 600
      </Button>
      <Button size={'sm'} color={'magenta-200'}>
        Magenta 200
      </Button>
    </Stack>
  </Story>
...
<Preview>
  <Story name="Button with icon">
    <Stack>
      <Button isFilled={true} size={'lg'} iconLeft={<Icon name={'dashboard'} color={'primary'} />}>
        Hello world
      </Button>
      <Button isFilled={true} size={'lg'} iconRight={<Icon name={'dashboard'} color={'primary'} />}>
        Hello world
      </Button>
      <Button
        isFilled={true}
        size={'lg'}
        iconLeft={<Icon name={'dashboard'} color={'primary'} />}
        iconRight={<Icon name={'dotsVertical'} color={'primary'} size={rem(18)} />}
      >
        Hello world
      </Button>
    </Stack>
...
<Preview>
  <Story name="Transparent Button">
    <Button type="primary" size={'lg'} isTransparent>
      Hello world
    </Button>
  </Story>
</Preview>
  ...
  <Story name="Block Button">
    <Stack isVertical>
      <Button
        ...
        isBlock
        iconLeft={<Icon name={'dashboard'} color={'primary'} />}
        iconRight={<Icon name={'dashboard'} color={'primary'} />}
      >
        Hello world
      </Button>
      <Button isFilled={false} size={'lg'} isBlock>
        Hello world
      </Button>
      <Button type="success" size={'lg'} isTransparent isBlock>
        Hello world
      </Button>
    </Stack>
  </Story>
...
<Preview>
  <Story name="Dynamic Button Props" parameters={{ decorators: [withKnobs] }}>
    <Button
      type={select(
        'type',
        ['primary', 'secondary', 'success', 'error', 'info', 'warning', 'primary', 'secondary'],
        'secondary'
      )}
...
<Preview>
  <Story name="Async Button">
    <Stack>
      ...
      <AsyncButtonShowcase type={'secondary'} text={'Async md'} btnSize={'md'} />
