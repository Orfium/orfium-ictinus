...
<Canvas name="Text Tooltip" play={hoverOnTooltips} autoPlay>
  <Stack>
    <Function>
      {() => {
        return (
...
<Canvas name="Interactive Tooltip" play={hoverOnTooltips} autoPlay>
  <Stack>
    <TooltipShowcase />
  </Stack>
  <Stack isInverted>
...
<Canvas name="Tooltip Placement" play={hoverOnTooltips} autoPlay>
  <Stack>
    <Function>
      {() => {
        return (
...
<Canvas name="Playground" parameters={{ decorators: [withKnobs] }} play={hoverOnTooltips} autoPlay>
  <Stack>
    <Function>
      {() => {
        return (
