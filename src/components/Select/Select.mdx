...
<UsageGuidelines
  guidelines={[
    'If you need to select and enter a single item from a dropdown list with up to seven items, use simple select.',
    'If you need to select and enter a single item from a large dropdown list (7+ items), use searchable select.',
    'If you need to select and enter one or more items from a dropdown list, use multiselect.',
    'If you need to select and enter one or more items as free text or from a dropdown list, use searchable select.',
  ]}
/>
