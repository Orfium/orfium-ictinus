...
<Meta title="Design System/Select" component={Select} parameters={{
  design: [{
    type: 'figma',
    name: 'Select',
    url: `${FIGMA_URL}?node-id=917%3A44544`,
  }, {
    type: 'figma',
    name: 'Edge cases',
    ...
    type: 'figma',
    name: 'Filled on focus state',
    url: `${FIGMA_URL}?node-id=1046%3A44409`,
  }],
}} />
