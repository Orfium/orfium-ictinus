...
<Meta title="Design System/Asset Matching" parameters={{
  design: [{
    name: 'Asset Matching',
    type: 'figma',
    url: `${FIGMA_URL}?node-id=10283%3A104351`,
  }, {
    name: 'Card Actions (Asset Matching)',
    type: 'figma',
    url: `${FIGMA_URL}?node-id=3987%3A53433`,
  }],
}} />
