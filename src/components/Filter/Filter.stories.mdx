...
<Preview>
  <Story name="Filter with style types">
     <h2>Preset</h2>
    <Stack>
       <FilterShowcase styleType="filled" color="lightGrey-50" />
       <FilterShowcase styleType="outlined" color="lightGrey-50" />
       <FilterShowcase styleType="elevated" color="lightGrey-50" />
       <FilterShowcase styleType="transparent" color="lightGrey-50" />
    </Stack>
    <h2>Added</h2>
    <Stack>
      <FilterShowcase styleType="filled" filterType="added" color="purple-150" />
      <FilterShowcase styleType="outlined" filterType="added" color="purple-150" />
      <FilterShowcase styleType="elevated" filterType="added" color="purple-150" />
    </Stack>
  </Story>
</Preview>
...
<Preview>
  <Story name="Searchable Filter">
    <Stack>
       <FilterShowcase styleType="filled" isSearchable color="lightGrey-50" />
    </Stack>
  </Story>
</Preview>
...
<Preview>
  <Story name="Dynamic Filter Props" parameters={{ decorators: [withKnobs] }}>
    <FilterShowcase
        ...
        color={select('color', ['lightGrey-50', 'magenta-100', 'darkGrey-700', 'red-500'], 'lightGrey-50')}
