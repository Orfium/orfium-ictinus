...
<Preview>
  <Story name="Filter with style types">
     <h2>Preset</h2>
    <Stack>
       <FilterShowcase styleType="filled" color="lightTintedGrey-50" />
       <FilterShowcase styleType="outlined" color="lightTintedGrey-50" />
       <FilterShowcase styleType="elevated" color="lightTintedGrey-50" />
       <FilterShowcase styleType="transparent" color="lightTintedGrey-50" />
    </Stack>
    <h2>Added</h2>
    <Stack>
      <FilterShowcase styleType="filled" filterType="added" color="purple-50" />
      <FilterShowcase styleType="outlined" filterType="added" color="purple-50" />
      <FilterShowcase styleType="elevated" filterType="added" color="purple-50" />
    </Stack>
  </Story>
</Preview>
...
<Preview>
  <Story name="Filter with colors">
    <Stack>
       <FilterShowcase styleType="filled" color="purple-50" />
       <FilterShowcase styleType="outlined" color="red-500" />
       <FilterShowcase styleType="elevated" color="darkGrey-300"/>
...
<Preview>
  <Story name="Searchable Filter">
    <Stack>
       <FilterShowcase styleType="filled" isSearchable color="lightTintedGrey-50" />
    </Stack>
  </Story>
</Preview>
...
<Preview>
  <Story name="Dynamic Filter Props" parameters={{ decorators: [withKnobs] }}>
    <FilterShowcase
        ...
        color={select('color', ['lightTintedGrey-50', 'magenta-100', 'darkGrey-700', 'red-500'], 'lightTintedGrey-50')}
