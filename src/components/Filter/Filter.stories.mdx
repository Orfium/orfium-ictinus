...
<Preview>
  <Story name="Filter with style types">
    ...
    <h2>Added</h2>
    <Stack>
      <FilterShowcase styleType="filled" filterType="added" color="vividPurple-100" />
      <FilterShowcase styleType="outlined" filterType="added" color="vividPurple-100" />
      <FilterShowcase styleType="elevated" filterType="added" color="vividPurple-100" />
      <FilterShowcase styleType="transparent" filterType="added" color="vividPurple-100" />
    </Stack>
  </Story>
</Preview>
