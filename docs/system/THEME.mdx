...
| typography  | [Typography](../?path=/docs/design-tokens-semantic-typography--overview) |
| spacing     | [Spacing](../?path=/docs/design-tokens-global-spacing--overview)         |
| elevation   | [Elevation](#theme-elevation)                                            |
| colorScheme | string ('light' or 'dark')                                               |
| utils       | [Utility Functions](../?path=/docs/system-utilities--overview)           |
...
Those elevations can be found in the [Card](../?path=/docs/original-components-card--overview) component where you can define in a card the elevation that you want but you can also use a specific elevation
...
As mentioned in the design spacing [section](../?path=/docs/design-tokens-global-spacing--overview) we are using specific metrics of spacings.
