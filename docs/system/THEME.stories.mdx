...
| isDark     | boolean                                                                                                               |
| utils      | [Utility Functions](/?path=/story/system-utils--page) ([getColor](/?path=/story/system-utils--page#getcolor) for now) |
...
| branded1  | Type - [Shades](/?path=/story/guide-colors--page#shades)                                 |
| branded2  | Type - [Shades](/?path=/story/guide-colors--page#shades)                                 |
...
Those elevations can be found in the [Card](/?path=/docs/design-system-card--card-with-elevation#card) component where you can define in a card the elevation that you want but you can also use a specific elevation
...
| --------- | -------- | -------- | ---- | ------ | ------------------- |
| 01        | 0        | 2        | 4    | 0      | rgba(0, 0, 0, 0.15) |
| 02        | 0        | 4        | 8    | 0      | rgba(0, 0, 0, 0.15) |
| 03        | 0        | 8        | 18   | 0      | rgba(0, 0, 0, 0.15) |
| 04        | 0        | 16       | 24   | 0      | rgba(0, 0, 0, 0.15) |
