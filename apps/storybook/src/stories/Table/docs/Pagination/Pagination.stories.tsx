...
import { moreData, simpleColumns, simpleData } from '../../constants';
import { chunk, concat } from 'lodash-es';
import { type SelectOptionValues, Table, type TableColumn } from '@orfium/ictinus';
  ...
  render: (args) => {
    ...
    return (
      <Table
        ...
        columns={simpleColumns as TableColumn<typeof simpleData>[]}
        rowSize={rowSize}
