import { TableV4 } from '@orfium/ictinus';
...
export const RegularTableWithSimpleRows: Story = {
  render: () => (
    <TableV4
...
export const RegularTableWithSortingAndTooltips: Story = {
  render: () => (
    <TableV4
      columns={[
        {
...
export const TableWithExpandableRowsExpandedOnPageLoad: Story = {
  render: () => (
    <TableV4
      columns={['Title', 'Name', 'Surname', 'Age']}
      padded
...
export const FixedHeaderTable: Story = {
  render: () => (
    <TableV4
      columns={['Title', 'Name', 'Surname', 'Age']}
      onCheck={console.log}
...
export const TableWithExpandableRowsAndSortDir: Story = {
  render: () => (
    <TableV4
      columns={[
        {
...
export const TableWithFilteredDataForPerformance: Story = {
