const transform = (file, api) => {
  ...
  const spacingReplaceMap = {
    'theme.spacing.xsm': "vars.spacing['3']",
    'theme.spacing.sm': "vars.spacing['4']",
    'theme.spacing.md': "vars.spacing['6']",
    'theme.spacing.lg': "vars.spacing['8']",
    'theme.spacing.xl': "vars.spacing['9']",
    'props.theme.spacing.xsm': "props.vars.spacing['3']",
    'props.theme.spacing.sm': "props.vars.spacing['4']",
    'props.theme.spacing.md': "props.vars.spacing['6']",
    'props.theme.spacing.lg': "props.vars.spacing['8']",
    'props.theme.spacing.xl': "props.vars.spacing['9']",
