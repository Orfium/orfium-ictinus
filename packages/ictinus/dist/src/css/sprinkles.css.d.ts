...
export declare const sprinkles: ((props: {
    ...
    properties: Set<"minHeight" | "minWidth" | "height" | "width" | "color" | "p" | "borderRadius" | "boxShadow" | "px" | "borderWidth" | "letterSpacing" | "backgroundColor" | "borderColor" | "fontSize" | "fontWeight" | "fontFamily" | "lineHeight" | "flex" | "padding" | "position" | "alignItems" | "alignSelf" | "cursor" | "display" | "flexDirection" | "flexWrap" | "isolation" | "justifyContent" | "marginBottom" | "marginLeft" | "marginRight" | "marginTop" | "objectFit" | "outlineColor" | "paddingBottom" | "paddingLeft" | "paddingRight" | "paddingTop" | "pointerEvents" | "textTransform" | "touchAction" | "transitionDuration" | "transitionProperty" | "transitionTimingFunction" | "userSelect" | "visibility" | "whiteSpace" | "wordBreak" | "wordWrap" | "zIndex" | "borderStyle" | "gap" | "margin" | "gridGap" | "pt" | "pr" | "pb" | "pl" | "py" | "m" | "mt" | "mr" | "mb" | "ml" | "mx" | "my" | "h" | "w" | "bg">;
};
